<p align="center">
  <img src="./poly_ops_banner.png" alt="Poly Ops Tactical Shooter Banner" width="100%">
</p>

<h1 align="center">🎖️ POLY OPS: TACTICAL SHOOTER 🎖️</h1>

<p align="center">
  <strong>An Immersive, Ultra-Optimized Low-Poly 3D First-Person Shooter Running Natively in Your Web Browser!</strong>
</p>

<p align="center">
  <a href="https://github.com/Blue-Rangoon/Poly-Ops-Tactical-Shooter"><img src="https://img.shields.io/badge/build-passing-10b981?style=for-the-badge&logo=github" alt="Build Status"></a>
  <a href="https://poly-ops.vercel.app"><img src="https://img.shields.io/badge/deployment-successful-10b981?style=for-the-badge&logo=vercel" alt="Vercel Deployment"></a>
  <a href="https://api.visitorbadge.io/api/visitors?path=Blue-Rangoon.Poly-Ops-Tactical-Shooter&label=Repository%20Views&countColor=%2310b981&labelColor=%230f172a&style=for-the-badge"><img src="https://api.visitorbadge.io/api/visitors?path=Blue-Rangoon.Poly-Ops-Tactical-Shooter&label=Repository%20Views&countColor=%2310b981&labelColor=%230f172a&style=for-the-badge" alt="Repository Views"></a>
 [![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FBlue-Rangoon%2FPoly-Ops-Tactical-Shooter&count_bg=%2379C83D&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false)](https://hits.seeyoufarm.com)
  <a href="https://github.com/Blue-Rangoon/Poly-Ops-Tactical-Shooter/stargazers"><img src="https://img.shields.io/github/stars/Blue-Rangoon/Poly-Ops-Tactical-Shooter?style=for-the-badge&color=10b981&labelColor=0f172a" alt="GitHub Stars"></a>
  <a href="https://github.com/Blue-Rangoon/Poly-Ops-Tactical-Shooter/network/members"><img src="https://img.shields.io/github/forks/Blue-Rangoon/Poly-Ops-Tactical-Shooter?style=for-the-badge&color=10b981&labelColor=0f172a" alt="GitHub Forks"></a>
  <a href="https://github.com/Blue-Rangoon/Poly-Ops-Tactical-Shooter/blob/main/License"><img src="https://img.shields.io/github/license/Blue-Rangoon/Poly-Ops-Tactical-Shooter?style=for-the-badge&color=10b981&labelColor=0f172a" alt="License"></a>
</p>

---

## 🎮 Live Proving Grounds
Step into the battle zone instantly, completely hassle-free:
👉 **[🚀 PLAY POLY OPS LIVE ON VERCEL](https://poly-ops.vercel.app)**
...
The battlefield is engineered using cutting-edge, high-performance web standards:

<p align="center">
  <img src="https://img.shields.io/badge/react-%2320232a.svg?style=for-the-badge&logo=react&logoColor=%2361DAFB" alt="React">
  <img src="https://img.shields.io/badge/threejs-%23000000.svg?style=for-the-badge&logo=three.js&logoColor=white" alt="Three.js">
...
- **Core & Logic**: [React 19](https://react.dev) + [TypeScript](https://www.typescriptlang.org) for bulletproof state management, modular responsive overlays, and interactive HUD tracking.
- **3D Graphics Engine**: [Three.js](https://threejs.org) with flat-shaded low-poly rendering, WebGL lighting, real-time dynamic shadows, structural coordinate-space fog, and procedural foliage props.
- **Audio Synthesizer**: Immersive [Web Audio API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Audio_API) synthesis. No external audio files are downloaded; all soundscapes—including weapon fire, clunk-clack reloads, low-pitch combat background music, pain vocalizations, and breathing cycles—are compiled programmatically in real-time.
- **Styling**: [Tailwind CSS v4](https://tailwindcss.com) for responsive layouts, battlefield color accents, and premium glassmorphic overlays.
- **Build Tool**: [Vite](https://vite.dev) for lightning-fast hot module reloading and production asset compiling.
...
Experience the ultimate sound design powered natively by your browser's audio nodes:
...
### 2. Install Battlefield Dependencies
```bash
npm install
```

### 3. Deploy Local Hot-Reload Dev Server
```bash
npm run dev
```
Open the provided local address (typically `http://localhost:5173`) in any modern browser.
...
---
<p align="center">
  🚀 Deployed on <a href="https://poly-ops.vercel.app">Vercel</a> • Constructed with 💚 and TypeScript
</p>
